          ...
          <div className="hidden lg:block">
            <div className="max-w-2xl">
              <div className="flex items-center gap-5 mb-8">
                <div className="relative w-[110px] h-[97px] shrink-0">
                  <Image
                    src="/rai-icon.png"
                    alt="RAI Portal logo"
                    fill
                ...
                <div className="leading-none">
                  <p className="text-5xl font-extrabold">
                    <span className="text-[#0B2E7A] dark:text-white">RAI</span>{' '}
                    <span className="text-[#FF7A00]">PORTAL</span>
                  </p>
                  <p className="text-base font-semibold text-slate-900 dark:text-white tracking-wide mt-2 uppercase">
                    Real-Time Reports and Approvals
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-3xl border border-white/60 dark:border-slate-800 bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl shadow-2xl p-7 md:p-8">
              <div className="lg:hidden flex items-center gap-3 mb-6">
                ...
                <div className="leading-none">
                  ...
                  <p className="text-[11px] font-semibold text-slate-900 dark:text-white tracking-wide mt-1 uppercase">
                    Real-Time Reports and Approvals
                  </p>
                </div>
              </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      id="email"
                      type="text"
                      placeholder="Enter your user ID (e.g. 12345@yourcompany)"
                      value={email}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 pl-10 pr-11 rounded-xl border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                    />
                    <button
                      type="button"
