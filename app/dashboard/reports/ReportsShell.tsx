                  ...
                  {groupsToShow.map((group) => {
                    ...
                    const iconClass =
                      group.key === 'accounting'
                        ...
                        : group.key === 'crm'
                        ? isActive
                          ? 'border-[#f9c9de] bg-[#fdeef5] text-[#db2777] dark:border-pink-500/40 dark:bg-[#3a1229] dark:text-[#f472b6]'
                          : 'border-[#f9c9de] bg-[#fef1f7] text-[#db2777] dark:border-white/10 dark:bg-[#2a1522] dark:text-[#f9a8d4]'
                        : isActive
